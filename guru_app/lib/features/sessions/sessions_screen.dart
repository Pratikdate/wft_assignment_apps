...
class SessionsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('My Session Logs'),
          bottom: const TabBar(
            indicatorColor: AppColors.guruPrimary,
            labelColor: AppColors.guruPrimary,
                  ...
                  child: logs.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return _buildSessionLogCard(context, log, logService);
                          },
                        ),
                ),
              ],
  ...
  Widget _buildSessionLogCard(BuildContext context, SessionLog log, LogService logService) {
    ...
    return Card(
      ...
      child: InkWell(
        ...
        onTap: () => _showSessionDetails(context, log),
        child: Padding(
          padding: const EdgeInsets.all(16.0),
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    icon: const Icon(Icons.share, size: 18, color: AppColors.guruPrimary),
                    onPressed: () {
              ...
              if (log.memberNotes != null || log.trainerNotes != null) ...[
                ...
                Text(
                  log.memberNotes ?? log.trainerNotes ?? '',
                  maxLines: 1,
  ...
  void _showSessionDetails(BuildContext context, SessionLog log) {
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Call Session Details', style: Theme.of(context).textTheme.headlineMedium),
              const SizedBox(height: 4),
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Member Notes
                const Text('My Notes & Rating', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14.0)),
                const SizedBox(height: 4),
                if (log.rating != null) ...[
                  Row(
                ...
                // Trainer Notes
                const Text('Trainer Notes (Aarav)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14.0)),
                const SizedBox(height: 4),
                Text(
                  log.trainerNotes ?? 'Waiting for trainer feedback notes...',
                  style: TextStyle(
                    color: log.trainerNotes != null ? AppColors.textSecondary : AppColors.textMuted,
                    fontStyle: log.trainerNotes != null ? null : FontStyle.italic
                  ),
                ),
              ],
            ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const Icon(Icons.calendar_today, color: AppColors.guruPrimary, size: 20),
                const SizedBox(width: 8),
                Expanded(
                  child: Text(
                    dateStr,
                ...
                Container(
                  ...
                  child: Text(
                    timeStr,
                    style: const TextStyle(color: AppColors.guruPrimary, fontSize: 12, fontWeight: FontWeight.bold),
                  ),
                )
              ],
            ),
