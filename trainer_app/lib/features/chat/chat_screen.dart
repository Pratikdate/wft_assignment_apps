...
class _ChatScreenState extends ConsumerState<ChatScreen> {
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            if (isPeerTyping) _buildTypingIndicator(member),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          OutlinedButton(
            onPressed: () => _sendMessage('Hi DK 👋'),
            style: OutlinedButton.styleFrom(
              foregroundColor: AppColors.trainerPrimary,
              side: const BorderSide(color: AppColors.trainerPrimary, width: 1.5),
            ),
  ...
  Widget _buildChatBubble(Message msg, String? currentUserId) {
    ...
    // Bubble UI: Member = Blue, Trainer = Red
    final isSenderMember = msg.senderId == 'dk_member';
    final bubbleColor = isSenderMember ? AppColors.guruPrimary : AppColors.trainerPrimary;
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              msg.text,
              style: const TextStyle(color: textColor, fontSize: 15.0),
              textAlign: textAlign,
            ),
          ),
  ...
  Widget _buildStatusTick(MessageStatus status) {
    ...
    return Icon(
      ...
      size: 14,
      color: isRead ? AppColors.trainerPrimary : AppColors.textMuted,
    );
  }

  Widget _buildTypingIndicator(User member) {
    return Padding(
  ...
  Widget _buildQuickReplies() {
    final replies = ["Got it 👍", "Can we schedule next call?", "Check your sessions."];
    return Container(
      height: 48,
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: ActionChip(
              label: Text(reply, style: const TextStyle(fontSize: 13.0, color: AppColors.trainerPrimary)),
              backgroundColor: AppColors.surface,
              side: const BorderSide(color: AppColors.trainerPrimary, width: 0.8),
